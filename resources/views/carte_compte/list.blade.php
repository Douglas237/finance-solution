            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-control" id="carte_forme">
                        ...
                        <div class="row tout">
                            <div class="col right">
                              <input type="number" name="numero_carte" id="numero_carte" class="form-control first" placeholder="numero de carte" aria-label="numero de carte">
                              ...
                              <input type="date" name="date_creation" id="date_creation" class="form-control first" placeholder="Select Date" aria-label="date_creation">
                            </div>
                            <div class="col gauche">
                                <input type='number' name="codesecret" id="codesecret" class="form-control first" placeholder="code secret" aria-label="codesecret"/>
                                <input type="date" name="date_expiration" id="date_expiration" class="form-control first" placeholder="Select Date" aria-label="date_expiration">
                              <div>
