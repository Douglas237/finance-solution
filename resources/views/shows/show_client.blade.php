...
@section('content')
    <div class="infoclient">
        ...
        <a
                href="{{ route('compte_client',$id) }}"><button style="margin-right: 7rem;height: 2.9rem;width: 10rem; floating: right;" type="button" class="btn btn-success"> Ajouter compte</button></a> --}}
