...
App = {
    /* root  : $('input:hidden[name="approot"]').val().replace(/(\.html)$/i, ''),
    sectionUrl: $('input:hidden[name="sectionurl"]').val().replace(/(\.html)$/i, ''),
    apiUrl: $('input:hidden[name="apiurl"]').val().replace(/(\.html)$/i, ''),
    idUser: $('input:hidden[name="iduser"]').val() */
}
